    ...
    <div className="About background-profile">
      <div className="AboutText text-profile">
        ...
        <p>
         ...
         <p>
          sending hella special shout outs to Claire Silver, the teams at Superchief Gallery, A2 Accelerate Art, 50mm Collective, imnotArt Gallery, Nox Gallery, Superlative Gallery, and the MetaCannes Film Festival for putting my art in front of a worldwide audience... and even a times square billboard, thanks for that surprise Ed Zipco (!!!)
          </p>
          <p>
